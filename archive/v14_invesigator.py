...
st.set_page_config(page_title="Photo Detective v14.1", layout="wide")
st.title("🕵️ Photo Detective v14.1: Filename Inspector")
...
def create_filmstrip(cluster_items, cluster_id):
    ...
    for item in sorted_items:
        ...
        try:
            ...
            # We still keep it on image, but also show in UI now
    ...
    if not filtered_c_ids:
        ...
        for cid in current_ids:
            ...
            for idx, item in enumerate(items):
                ...
                with cols[idx+1]:
                    # --- NEW: VISIBLE METADATA ---
                    st.markdown(f"**{name}**")  # Bold Filename
